                      ...
                      <div>
                        <div className="flex justify-between">
                          <h3 className="text-sm">
                            <Link href={`/products/${item.product.slug}`} className="font-bold text-[#0F2131] hover:text-[#0A7A44]">
                              {item.product.title}
                            </Link>
                          </h3>
                        </div>
        ...
        <section className="mt-16 bg-gray-50 rounded-lg px-4 py-6 sm:p-6 lg:p-8 lg:mt-0 lg:col-span-5">
          ...
          <dl className="mt-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <dd className="text-sm font-medium text-gray-900">{formatPrice(convertedCartTotal)}</dd>
            </div>
            ...
            <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
              ...
              <dd className="text-base font-bold text-[#0F2131]">{formatPrice(convertedTotal)}</dd>
            </div>
          </dl>
