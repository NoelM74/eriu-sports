...
export const COLLECTIONS: CollectionDef[] = [
  ...
  },
  {
    ...
    intro:
      "Great shirts from beyond the Premier League: Barcelona, Real Madrid, Inter, AC Milan, Brazil, Italy and more. €25, or €35 with a player name and number. Delivered in 8–14 days.",
    ...
    keywords: ["retro Barcelona shirt", "Ronaldinho Barcelona shirt", "Ronaldo R9 shirt", "Baggio shirt", "retro Brazil shirt", "retro Inter Milan shirt", "retro Serie A shirts", "retro Juventus shirt", "retro Roma shirt", "retro Bayern Munich shirt", "retro European football shirts"],
    priceFrom: 25,
  },
  {
    slug: "gaa-jerseys",
