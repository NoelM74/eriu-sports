      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="col-span-1 sm:col-span-2 lg:col-span-1">
          ...
          <div className="flex gap-4 mt-6">
            {/* Instagram */}
            <a href="#" aria-label="Instagram" className="text-[#757575] hover:text-[#1C7C83] transition-colors">
            ...
            {/* Facebook */}
            <a href="#" aria-label="Facebook" className="text-[#757575] hover:text-[#1C7C83] transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
